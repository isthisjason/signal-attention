...
public class BacktestController {
    ...
    @GetMapping("/api/backtests/{id}/drawdown-series")
    public List<BacktestDrawdownPointResponse> getDrawdownSeries(@PathVariable Long id) {
        return backtestService.getDrawdownSeries(id);
    }
